...
| **PB1** | FAN_EN | GPIO_Output | 风扇电源使能控制 | 高电平有效 |
...
| **PA5** | FAN_DC | DAC1_OUT2 | 风扇 DC 调速信号 | 模拟电压 | DC 调速，连接 LDO 反馈 |
...
- **FAN_DC (PA5)**: 使用 DAC1_OUT2 输出模拟电压信号，控制风扇供电 LDO 的反馈回路
- **调速原理**: FAN_DC 电压越低，LDO 输出电压越高，风扇转速越快
- **电压范围**: 0V - 3.3V (12位 DAC 输出)
- **控制特性**: 反向控制逻辑，适用于基于 LDO 反馈的 DC 调速方案
